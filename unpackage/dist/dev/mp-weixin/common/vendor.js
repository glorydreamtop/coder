...
//get globalData
var juejin = uni.getStorageSync('juejin');
//base ajax
var ajax = function ajax(url, method, data, legacy) {
  var header1 = {
  ...
  var header = legacy ? header2 : header1;
  return new Promise(function (resolve, reject) {
    ...
    then(function (res) {
      var title;
      if (!res[0]) {
        var statusCode = res[1].statusCode;
        var _data = res[1].data;
        switch (statusCode) {
          case 200:
            resolve(_data);
            break;
      ...
      if (title) (0, _funcitons.Toast)(title);
    });
  });

};
//get ajax
var get = function get(url, data, legacy) {
  return ajax(url, 'GET', data, legacy);
};
//post ajax
var post = function post(url, data, legacy) {
  return ajax(url, 'POST', data, legacy);
};
//login
var login = function login(data) {
  var type = data.phoneNumber ? 'phoneNumber' : 'email';
  return post('https://juejin.im/auth/type/' + type, data).then(function (res) {
    (0, _funcitons.Toast)('登录成功');
    var juejin = {};var _ref =
    [
    res.token,
    res.userId,
    ...
    res.user.username];juejin.token = _ref[0];juejin.userId = _ref[1];juejin.clientId = _ref[2];juejin.avatarLarge = _ref[3];juejin.username = _ref[4];
...
//get categories
exports.login = login;var categories = function categories(data) {
  return get('https://gold-tag-ms.juejin.im/v1/categories', data).then(function (res) {
...
/***/ 7:
/*!***************************************************!*\
  !*** D:/github/coder/pages.json?{"type":"style"} ***!
  \***************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 8:
/*!**************************************************!*\
  !*** D:/github/coder/pages.json?{"type":"stat"} ***!
  \**************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
